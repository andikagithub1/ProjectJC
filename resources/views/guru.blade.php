            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fas fa-chalkboard-teacher"></i> Info Guru
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Nama Guru: John Doe</h5>
                        <p class="card-text">Mata Pelajaran: Matematika</p>
                        <p class="card-text">Pengalaman Mengajar: 10 Tahun</p>
                        <a href="{{ route('guru.profile') }}" class="btn btn-primary">Lihat Profil</a>
                    </div>
                </div>
            </div>
