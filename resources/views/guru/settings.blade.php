<!-- resources/views/guru/settings.blade.php -->
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container my-5">
        ...
        <p>Halaman ini untuk mengatur preferensi atau informasi lainnya terkait akun guru.</p>
        <!-- Tambahkan form pengaturan atau lainnya di sini -->
    </div>
