...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item untuk Halaman Guru -->
<li class="nav-item {{ Nav::isRoute('guru.index') }}">
    <a class="nav-link" href="{{ route('guru.index') }}">
        <i class="fas fa-fw fa-chalkboard-teacher"></i>
        <span>{{ __('Dashboard Guru') }}</span>
    </a>
</li>

<!-- Nav Item untuk Profil Guru -->
<li class="nav-item {{ Nav::isRoute('guru.profile') }}">
    <a class="nav-link" href="{{ route('guru.profile') }}">
        <i class="fas fa-fw fa-user"></i>
        <span>{{ __('Profil Guru') }}</span>
    </a>
</li>

<!-- Nav Item untuk Pengaturan Guru -->
<li class="nav-item {{ Nav::isRoute('guru.settings') }}">
    <a class="nav-link" href="{{ route('guru.settings') }}">
        <i class="fas fa-fw fa-cogs"></i>
        <span>{{ __('Pengaturan Guru') }}</span>
    </a>
</li>
